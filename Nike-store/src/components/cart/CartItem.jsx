        ...
        <div className="flex items-center gap-5">
          ...
          <div className="grid items-center gap-4">
            ...
            <div className="flex items-center justify-around w-full">
              ...
              >
                <MinusIcon className="w-5 h-5 lg:w-4 lg:h-4 text-zinc-600 stroke-[2]" />
              </button>
              <div className="bg-theme-cart rounded text-zinc-600 font-medium lg:text-xs w-7 h-6 lg:h-5 lg:w-6 flex items-center justify-center">
                {cartQuantity}
              </div>
              <button
                type="button"
                ...
                className="bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90"
              >
                <PlusIcon className="w-5 h-5 lg:w-4 lg:h-4 text-zinc-600 stroke-[2]" />
              </button>
            </div>
          </div>
        </div>
