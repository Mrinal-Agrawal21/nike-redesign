      ...
      <header
        className={
          !navState
            ...
            : "fixed top-0 left-0 right-0 h-[9vh] flex items-center justify-center bg-black/80 backdrop-blur-sm z-[200] shadow-sm"
        }
      >
        <nav className="flex items-center justify-between nike-container">
          ...
          <ul className="flex items-center justify-center gap-2">
            ...
            <li className="grid items-center">
              ...
              >
                <HeartIcon
                  className={`icon-style text-white hover:text-gray-400 transition-all duration-300`}
                  onClick={onLikeToggle}
                />
              </button>
            </li>
