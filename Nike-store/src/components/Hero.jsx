      ...
      <div className="relative h-auto w-auto flex flex-col">
        ...
        <div className="relative opacity-100 z-20 grid items-center justify-items-center nike-container">
          <div className="grid items-center justify-items-center mt-28 md:mt-24">
            <h1 className="text-6xl lg:text-5xl md:text-4xl sm:text-3xl xsm:text-2xl font-extrabold filter drop-shadow-sm text-slate-800">
              {title}
            </h1>
            <h1 className="text-6xl lg:text-5xl md:text-4xl sm:text-3xl xsm:text-2xl font-extrabold filter drop-shadow-sm text-slate-800">
              {subtitle}
            ...
            <button
              ...
              className="button-theme bg-slate-900 text-white hover:bg-slate-700 shadow-slate-200 rounded-xl my-5"
            >
              {btntext}
            </button>
